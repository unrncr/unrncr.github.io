...
<html lang="en">
	<head>
		<title>Surukenza: Username Recovery</title>
		...
		<script type="text/javascript" src="js/recoveruser.js"></script>
	...
	<body onload="InitUsernameRecover()">
		...
		<div class="container" style="height: 420px;">
			<div class="row">
				<div class="span12">
					<legend>Username Recovery</legend>
				</div>
			</div>
			<div class="row">
				<div class="span2">
			...
			<div class="row">
				<div class="span12">
					<button id="RecoveryButton" type="submit" class="btn btn-primary disabled" onclick="RecoverUsername()">Recover</button>
				</div>
			</div>
		</div>
